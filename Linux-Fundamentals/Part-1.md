...
We need to be able to do basic functions like navigate to files, output their contents, and make files. The commands to do so are self-explanatory once you know what they are.
...
When you feel comfortable with these tools, progress directly onto **Linux Fundamentals Part 2**!
